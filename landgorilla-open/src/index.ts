...
import loanContractorRoutes from './routes/loanContractors';
import drawRequestRoutes from './routes/drawRequests';
...
app.use('/api/loans/:loanId/contractors', loanContractorRoutes);
app.use('/api/loans/:loanId/draw-requests', drawRequestRoutes);
